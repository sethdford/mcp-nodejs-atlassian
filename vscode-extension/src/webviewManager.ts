...
export class WebviewManager {
    ...
    showSearchResults(title: string, results: any[]): void {
        const panel = vscode.window.createWebviewPanel(
            'atlassianResults',
            title,
    ...
    private async testConnection(config: any): Promise<boolean> {
        // Import here to avoid circular dependencies
        const { AtlassianProvider } = await import('./atlassianProvider');
    ...
    private getSearchResultsHtml(title: string, results: any[]): string {
